...
{
    public partial class EnumControl : BaseEmailTemplateControl//UserControl//
    {
        ...
        {
            EnumItems =
                                 ITLec.CRMEmailTemplateGuy.AppCode.EnumHelper.GetCustomEnumItems(_enumType);
            ITLec.CRMEmailTemplateGuy.AppCode.Common.FillComboBox(cmbEnum, EnumItems);
        ...
        private void SetCustomProperties()
        {
            ...
            var section = _emailTemplate.Sections.Where(e => e.Name.ToLower() == currentNodeName.ToLower()).FirstOrDefault();
