...
{
    public partial class FontControl : BaseEmailTemplateControl//UserControl//
    {
        ...
        {
            FontTypes = ITLec.CRMEmailTemplateGuy.AppCode.EnumHelper.GetCustomEnumItems("Font");
            ITLec.CRMEmailTemplateGuy.AppCode.Common.FillComboBox(comboBoxFontType, FontTypes);
        }
