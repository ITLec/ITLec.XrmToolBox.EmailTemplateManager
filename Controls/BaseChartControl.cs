...
{
    public abstract class BaseEmailTemplateControl : UserControl
    {

       public  BaseEmailTemplateControl()
        {
            //  IsNull = true;
        ...
        public ITLec.CRMEmailTemplateGuy.Property CurrentProperty
        {
            get
            {
               var retVal =  new ITLec.CRMEmailTemplateGuy.Property() {/*DefaultValue = this.InitValue,*/ Desc=this.Desc, DisplayName=this.Label, Name= this.Key, Value = this.Value};
