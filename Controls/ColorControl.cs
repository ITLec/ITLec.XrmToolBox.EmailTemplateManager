...
{
    public partial class ColorControl :BaseEmailTemplateControl// UserControl//
    {
        ...
        protected override void SetValue(string val)
        {
            ...
            checkBoxIgnoreSaving.Visible = true;
                ...
                Color color = ITLec.CRMEmailTemplateGuy.AppCode.Common.ConvertStringToColor(val).Value;
        ...
        private void textBoxColor_TextChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                Color? color = ITLec.CRMEmailTemplateGuy.AppCode.Common.ConvertStringToColor(textBoxColor.Text);
                if (color != null)
                {
