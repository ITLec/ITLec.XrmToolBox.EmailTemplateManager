...
{
public  class BaseMainEmailTemplateUserControl :  UserControl
    {
        ...
        public Dictionary<string, BaseEmailTemplateControl> DictionaryKeyControl = new Dictionary<string, BaseEmailTemplateControl>();

        
        public void AddDictionaryKeyControl(BaseEmailTemplateControl obj, Property property)
        {
       ...
       /* public void AddDictionaryKeyControl(BaseEmailTemplateControl obj, string key, string val, string label = "")
        {
    ...
    //        var val = property.DefaultValue;
        ...
        public void AddDictionaryKeyControl(Property property)
        {
            ...
            if (!DictionaryKeyControl.ContainsKey(property.Name))
            {
                ...
                BaseEmailTemplateControl obj = null;
