...
namespace ITLec.CRMEmailTemplateGuy.AppCode
{
    ...
    {
        /*
        public static Dictionary<string, string> GetAllEmailTemplateTypes()
        {
      ...
      /*  public static Dictionary<string, string> GetAllFontTypes()
        ...
        public static Dictionary<string, string> GetCustomEnumItems(string enumType)
        {
            ...
            var customEnum = _emailTemplate.CustomEnums.Where(e => e.Name.ToLower() == enumType.ToLower()).FirstOrDefault();
