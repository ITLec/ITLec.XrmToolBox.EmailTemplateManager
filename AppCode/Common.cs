...
namespace ITLec.CRMEmailTemplateGuy.AppCode
{
    public  class Common
    {
        ...
        private static ITLec.CRMEmailTemplateGuy.EmailTemplate emailTemplateStructure = null;

        public static string EmailTemplateStructurePath
        {
            get
            {
                string pluginLocation = XrmToolBox.Extensibility.Paths.SettingsPath;

                return string.Format("{0}\\{1}", pluginLocation,"EmailTemplateStructure.xml");
            }
        }

        public static ITLec.CRMEmailTemplateGuy.EmailTemplate EmailTemplateStructure
        {
            get
            {
                //if(emailTemplateStructure == null)
                //{
                    emailTemplateStructure = (ITLec.CRMEmailTemplateGuy.EmailTemplate)ITLec.CRMEmailTemplateGuy.AppCode.Common.DeserializeObj(EmailTemplateStructurePath, new ITLec.CRMEmailTemplateGuy.EmailTemplate());
                //}

                return emailTemplateStructure;
            }
        }

        public static string DetectEmailTemplateElementType(string key, string value)
        {
